              ...
              <Popup className="custom-popup">
                <div className="p-1 min-w-[200px]">
                  <div className="flex justify-between items-start">
                     <h3 className="font-bold text-lg text-pink-600">{spot.name}</h3>
                  ...
                  <button className="mt-3 w-full py-2 bg-pink-600 text-white text-sm font-medium rounded-md hover:bg-pink-700 transition-colors">
                    Plan Date Here
                  </button>
                </div>
              </Popup>
